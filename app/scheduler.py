...
from app.controllers.ibge_controller import save_ipca_ibge_data, save_desemprego_ibge_data
...
def start_scheduler(app):
    ...
    # scheduler.add_job(func=lambda: save_desemprego_ibge_data(app), trigger="interval", minutes=2)
